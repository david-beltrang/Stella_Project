...
public class Post {
    ...
    private Post(Integer id, Integer usuario_id, Contenido contenido) {
        this.id = id;
    ...
    public static Post crear(Integer usuario_id, String contenidoTexto) {
        return new Post(null, usuario_id, new Contenido(contenidoTexto));
    }

    public static Post reconstruir(Integer id, Integer usuarioId, Contenido contenido, int likes, LocalDateTime fechaCreacion) {
        Post post = new Post(id, usuarioId, contenido);
        post.likes = likes;
