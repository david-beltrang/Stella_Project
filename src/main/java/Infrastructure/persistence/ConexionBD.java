...
/**
 * Implementación Singleton thread-safe del patrón DAO para gestión de conexiones a base de datos.
 * Aplica el principio de Indirection y Low Coupling al abstraer la creación de conexiones.
 */
