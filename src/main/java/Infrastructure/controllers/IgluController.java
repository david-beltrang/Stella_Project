...
public class IgluController {
    ...
    // ====== NUEVAS DEPENDENCIAS ======
    private final UsuarioStatsService usuarioStatsService = AppServices.getUsuarioStatsService();
    private final PomodoroTimer pomodoroTimer = AppServices.getPomodoroTimer();
    ...
    // ===== NUEVOS LABELS =====
    @FXML private Label pescaditosLabel;
    ...
    // STATS DEL USUARIO
    // =========================
    private void inicializarStatsUsuario() {
        try {
            ...
            if (pescaditosLabel != null) pescaditosLabel.setText("0");
        }
        ...
        try {
            ...
            if (rachaLabel != null) rachaLabel.setText("0");
        }
    }
    ...
    private void setupPomodoroHud() {
        ...
        // Nada más que vincular si existiera un label de timer
        // El Iglú no tiene timerLabel en su UI actual
    }
    ...
    private void openWeeksPopup(int month) {
        try {
            ...
            SemanaPopupController controller = loader.getController();
