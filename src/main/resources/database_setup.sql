...
-- TABLA: UsuarioStats (Estadísticas y gamificación)
...
-- Columnas renombradas para coincidir con el código Java que falló (TIPO_CONTENIDO, CONTENIDO_HTML)
...
-- SECCIÓN 1: Introducción al C++ y fundamentos
...
INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (17, '¿Qué hace la palabra clave "return"?', NULL, 103);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
...
INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (18, '¿Cómo se accede a los miembros de una estructura?', NULL, 103);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
                                                             (78, 18, '->', FALSE), (79, 18, '.', TRUE), (80, 18, '::', FALSE), (81, 18, ':', FALSE);

INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (19, '¿Qué tipo de parámetro modifica la variable original?', NULL, 103);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
                                                             (82, 19, 'Por valor', FALSE), (83, 19, 'Por copia', FALSE), (84, 19, 'Por referencia', TRUE), (85, 19, 'Por nombre', FALSE);


-- QUIZ SECCIÓN 4 (ID Prueba 104)
INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (20, '¿Cómo se declara un arreglo de 10 enteros?', NULL, 104);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
                                                             (86, 20, 'int array[10];', TRUE), (87, 20, 'array int[10];', FALSE), (88, 20, 'int[10] array;', FALSE), (89, 20, 'integer array(10);', FALSE);

INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (21, '¿Qué operador obtiene la dirección de una variable?', NULL, 104);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
                                                             (90, 21, '*', FALSE), (91, 21, '&', TRUE), (92, 21, '->', FALSE), (93, 21, '@', FALSE);

INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (22, '¿Qué hace el operador * con punteros?', NULL, 104);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
...
INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (23, '¿Cuál es el primer índice de un arreglo?', NULL, 104);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
                                                             (98, 23, '0', TRUE), (99, 23, '1', FALSE), (100, 23, '-1', FALSE), (101, 23, '10', FALSE);

INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (24, '¿El nombre de un arreglo es...?', NULL, 104);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
...
INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (25, '¿Qué incluye necesario para usar cout y cin?', NULL, 105);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
                                                             (106, 25, '#include <iostream>', TRUE), (107, 25, '#include <string>', FALSE), (108, 25, '#include <math>', FALSE), (109, 25, '#include <input>', FALSE);

INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (26, '¿Cuál es la salida de: for(int i=0; i<3; i++) cout << i;', NULL, 105);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
                                                             (110, 26, '012', TRUE), (111, 26, '123', FALSE), (112, 26, '0123', FALSE), (113, 26, '111', FALSE);

INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (27, '¿Qué devuelve una función void?', NULL, 105);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
                                                             (114, 27, '0', FALSE), (115, 27, '1', FALSE), (116, 27, 'Nada', TRUE), (117, 27, 'Un valor aleatorio', FALSE);

INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (28, '¿Cómo se declara un puntero a entero?', NULL, 105);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
                                                             (118, 28, 'int ptr;', FALSE), (119, 28, 'int* ptr;', TRUE), (120, 28, 'pointer int;', FALSE), (121, 28, 'ptr int*;', FALSE);

INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (29, '¿Qué hace break en un switch?', NULL, 105);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
...
INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (30, '¿Cómo se accede al tercer elemento de un arreglo?', NULL, 105);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
                                                             (126, 30, 'array[2]', TRUE), (127, 30, 'array[3]', FALSE), (128, 30, 'array(2)', FALSE), (129, 30, 'array(3)', FALSE);

INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (31, '¿Qué operador representa "OR" lógico?', NULL, 105);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
                                                             (130, 31, '&&', FALSE), (131, 31, '||', TRUE), (132, 31, '!', FALSE), (133, 31, '&', FALSE);

INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (32, '¿Cuál es el tipo de retorno de main()?', NULL, 105);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
                                                             (134, 32, 'void', FALSE), (135, 32, 'int', TRUE), (136, 32, 'float', FALSE), (137, 32, 'string', FALSE);

INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (33, '¿Qué struct es correcto?', NULL, 105);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
...
INSERT INTO pregunta (id, enunciado, leccion_id, prueba_id) VALUES (34, '¿Qué imprime: int x=5; cout << ++x;', NULL, 105);
INSERT INTO opcion (id, pregunta_id, texto, es_correcta) VALUES
